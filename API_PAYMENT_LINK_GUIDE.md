...
sequenceDiagram
    ...
    User->>VG: Processes Payment (Stripe)
...
**API Key for reference:** `836c816bfd3529cf9efd137f1ba198c07af61e1c08278656777d6a9136651603`
...
const API_KEY = "836c816bfd3529cf9efd137f1ba198c07af61e1c08278656777d6a9136651603";
...
// --- PHP (curl) ---
<?php
$apiKey = "836c816bfd3529cf9efd137f1ba198c07af61e1c08278656777d6a9136651603";
$url = "https://api.vouchergalaxy.com/api/v1/external/payment-link";
...
Copy and paste this into your terminal for a quick test:

```bash
curl -X POST https://api.vouchergalaxy.com/api/v1/external/payment-link \
  -H 'Content-Type: application/json' \
  -H 'X-Signature: d360009e7eafaf297a7ebb2dfb65f359a586e2475b6d644d8391dac0731674e0' \
  -d '{"phone_number":"+971501234567","amount":150.0,"currency":"AED","reference_id":"REF-C4D1BFB1","return_url":"https://omillionaire.com","webhook_url":"https://n8n.thegreencertificate.com/webhook/4cc151bc-f040-4d28-adaa-7fec804cde2f"}'
```
