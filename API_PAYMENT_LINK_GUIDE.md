...
| `currency` | string | ✅ | 3-letter currency code from supported list (e.g., `AED`, `SAR`, `USD`, `INR`). **Note:** OMR is not supported. |
...
```json
{
  ...
  "status": "success",
  "amount": 150.0,
  "currency": "AED",  // Returns actual transaction currency
  "payment_id": "pi_...",
  "reference_id": "ORD-12345",
  "failure_reason": null
}
...
The API supports major international and regional currencies, including:
...
> **Note:** Omani Rial (OMR) is currently **not supported** by the payment gateway.
